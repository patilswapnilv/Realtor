  ...
  jQuery(".search-sec input").focus(function(){
  	jQuery(".search-sec button").addClass('white');
  	});
  jQuery(".search-sec input").blur(function(){
  ...
  jQuery(".text-option i").click(function(){
  	jQuery(".text-option i").fadeOut();
  	jQuery(".text-option .dropdown-menu").slideUp();
  });
  jQuery(".text-option input").click(function(){
  	jQuery(".text-option i").fadeIn();
  	jQuery(".text-option .dropdown-menu").slideDown();
  });
  /*++++Custom Galery++++*/	

  jQuery(".custom-galery .overlay label").on('click', function(){
  	jQuery(".custom-galery").removeClass('open');
  });
  jQuery(".r-property-image a,.news-img,#owl-floor-plan .item img").on('click', function(){
